  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const { data } = axios.put(
        `/api/v1/nescafe/product/update-product/${id}`,
        productData
      );
      if (data?.success) {
        ...
        navigate("/dashboard/nescafe/admin/products");
      }
    } catch (error) {
      console.log(error);
  ...
  const handleDelete = async () => {
    try {
      ...
      const { data } = await axios.delete(
        `/api/v1/nescafe/product/delete-product/${id}`
      );
            ...
            <div className="">
              ...
              <div className="mb-3">
                {photo ? (
                  ...
                  <div className="text-center">
                    <img
                      src={`/api/v1/nescafe/product/product-photo/${id}`}
                      alt="product_photo"
                      height={"200px"}
                      className="img img-responsive"
                    />
