...
const AdminOrders = () => {
  ...
  const getOrders = async () => {
    try {
      const { data } = await axios.post("/api/v1/auth/all-orders/silver-spoon",{outlet: "silver-spoon"});
      setOrders(data);
    } catch (error) {
      console.log(error);
    }
  ...
  return (
    <Layout title={"All Orders Data"}>
      <div className="row dashboard" >
        ...
        <div className="col-md-6" style={{marginLeft:"10rem",marginTop:"2rem",padding:"3rem", alignItems:"center", border:"0.2rem solid #235789", borderRadius:"2rem"}}>
