        ...
        <div className='d-flex align-items-center justify-content-center' >
            <div className='row megadiv mx-auto d-flex justify-content-center'>
                <div className='col-md-4 subdiv d-flex justify-content-center'>
                    ...
                    <div className="card-bodyv1">
                        <h3 className="card-title mb-4 mt-2">NESCAFE</h3>
                        <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="/nescafe" className="btn btn-outline-dark mb-2 mt-4">Visit Page</a>
                    </div>
                    </div>
                </div>
                <div className="col-md-4 subdiv d-flex justify-content-center">
                    ...
                    <div className="card-bodyv2">
                        ...
                        <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="/coming-soon-tmp" className="btn btn-outline-dark mb-2 mt-4">Visit Page</a>
                    </div>
                    </div>
                </div>
                <div className="col-md-4 subdiv d-flex justify-content-center">
